Shader "ToonPipeline/Standard"
{
    // Keep properties of StandardSpecular shader for upgrade reasons.
    Properties
    {
        _BaseColor("Color", Color) = (0.5, 0.5, 0.5, 1)
        _BaseMap("Base (RGB) Glossiness / Alpha (A)", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile _ _GLOBAL_DIRECTLIGHTING
            #pragma multi_compile _ _LOCAL_DIRECTLIGHTING
            #pragma multi_compile _ _GLOBAL_SHADOW
            #pragma multi_compile _ _LOCAL_SHADOW
            #pragma multi_compile _ _GLOBAL_INDIRECTLIGHTING
            #pragma multi_compile _ _LOCAL_INDIRECTLIGHTING
            #pragma multi_compile _ _GLOBAL_FOG
            #pragma multi_compile _ _LOCAL_FOG
            #pragma multi_compile _ _GLOBAL_RIMLIGHT
            #pragma multi_compile _ _LOCAL_RIMLIGHT
