...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    sealed class PostProcessSystem
    {
        ...
        void DoTemporalAntialiasing(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination, RTHandle depthBuffer)
        {
            ...
            m_TAAPropertyBlock.SetInt(HDShaderIDs._StencilMask, (int)StencilAfterOpaque.ExcludeFromTAA);
            m_TAAPropertyBlock.SetInt(HDShaderIDs._StencilRef, (int)StencilAfterOpaque.ExcludeFromTAA);
        ...
        void DoSMAA(CommandBuffer cmd, HDCamera camera, RTHandle source, RTHandle destination, RTHandle depthBuffer)
        {
            ...
            m_SMAAMaterial.SetInt(HDShaderIDs._StencilRef, (int)StencilAfterOpaque.SMAA);
            m_SMAAMaterial.SetInt(HDShaderIDs._StencilMask, (int)StencilAfterOpaque.SMAA);
