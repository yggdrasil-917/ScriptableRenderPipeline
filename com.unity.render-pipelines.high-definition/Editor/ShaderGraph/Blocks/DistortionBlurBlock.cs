...
{
    [Title("HDRP SurfaceData", "Distortion Blur")]
    class DistortionBlurBlock : BlockData
    {
        public DistortionBlurBlock()
        {
        ...
        {
            AddSlot(new Vector1MaterialSlot(0, "DistortionBlur", "DistortionBlur", SlotType.Input, 1, ShaderStageCapability.Fragment));
