...
#define UNITY_DECLARE_FRAMEBUFFER_INPUT_FLOAT_MS(idx) ERROR_ON_UNSUPPORTED_FUNCTION(UNITY_DECLARE_FRAMEBUFFER_INPUT_FLOAT_MS)
#define UNITY_DECLARE_FRAMEBUFFER_INPUT_HALF_MS(idx) ERROR_ON_UNSUPPORTED_FUNCTION(UNITY_DECLARE_FRAMEBUFFER_INPUT_HALF_MS)

#define UNITY_READ_FRAMEBUFFER_INPUT_MS(idx, sampleIdx, v2fvertexname) ERROR_ON_UNSUPPORTED_FUNCTION(UNITY_READ_FRAMEBUFFER_INPUT_MS)
