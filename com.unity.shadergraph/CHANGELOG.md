...
- Shader Graphs and Sub Graphs now display a dialog asking if the user would like to "Save As" or close the window when the file associated with the window has been deleted.
