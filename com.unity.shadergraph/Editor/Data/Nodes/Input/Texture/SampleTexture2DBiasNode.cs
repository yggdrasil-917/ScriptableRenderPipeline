...
{
    [Title("Input", "Texture", "Sample Texture 2D Bias")]
    class SampleTexture2DBiasNode : AbstractMaterialNode, IGeneratesBodyCode, IMayRequireMeshUV
    {
        ...
        const string kBiasInputName = "Bias";

        public override bool hasPreview { get { return true; } }

        public SampleTexture2DBiasNode()
        {
            name = "Sample Texture 2D Bias";
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            AddSlot(new Vector1MaterialSlot(BiasInput, kBiasInputName, kBiasInputName, SlotType.Input, 0.0f));
            RemoveSlotsNameNotMatching(new[] { OutputSlotRGBAId, OutputSlotRId, OutputSlotGId, OutputSlotBId, OutputSlotAId, TextureInputId, UVInput, SamplerInput, BiasInput });
        }
        ...
        public virtual void GenerateNodeCode(ShaderStringBuilder sb, GenerationMode generationMode)
        {
            ...
            var biasValue = GetSlotValue(BiasInput, generationMode);
            ...
            var result = string.Format("$precision4 {0} = {1}.SampleBias({2}, {3}, {4});"
